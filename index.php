            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="glass-card rounded-4 p-4 h-100 text-center shadow-lg flex flex-col justify-between">
                        ...
                        <a href="hotels.php" class="btn btn-danger w-100 rounded-pill manage-btn py-2 mt-auto">Open Bookmarks</a>
                    </div>
                </div>
                ...
                <div class="mt-5 p-4  border-warning rounded bg-warning bg-opacity-10 text-center">
                        <a href="logout.php" class="btn btn-warning">Logout</a>
                </div>

                <?php if (strtolower($_SESSION['user']['role']) === 'admin'): ?>
                    <div class="mt-5 p-4  border-warning rounded bg-warning bg-opacity-10 text-center">
                        <p class="text-warning mb-2">You are logged in as an administrator.</p>
